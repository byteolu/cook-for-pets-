...
export default function ImgCaption() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    .then(async (response: any) => {
      ...
      // "YO" + "My DOG" + " is a doberman"  reader.read();
      while (true) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-md">
      <div className='bg-slate-400 w-full max-w-2xl rounded-lg shadow-md p-8'>
        ...
        { image !== "" ?
          ...
          src={image}
          alt="Uploaded Image"
          width={640} // Specify the actual width of your image
          height={360} // Specify the actual height of your image
          sizes="(max-width: 640px) 100vw, 640px" // Specify the sizes attribute
        />
          </div>
        :
